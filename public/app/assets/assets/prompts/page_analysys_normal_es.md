...
2. Identifica los conceptos y temas principales MÁS IMPORTANTES del texto (céntrate en las ideas clave, no en cada pequeño detalle).
3. Crea **3 subtemas** a partir de esta página.
...
- **CANTIDAD: Crea exactamente 3 subtemas a partir de esta página.**
...
Devuelve el análisis en el siguiente formato JSON (crea exactamente 3 subtemas):
