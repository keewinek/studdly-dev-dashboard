...
2. Identify the MOST IMPORTANT main concepts and topics in the text (focus on key ideas, not every small detail).
3. Create **3 sub-topics** from this page.
...
- **QUANTITY: Create exactly 3 sub-topics from this page.**
...
Return the analysis in the following JSON format (create exactly 3 sub-topics):
