...
2. Identifikasi konsep atau topik utama PALING PENTING dalam teks (fokus pada ide kunci, bukan setiap detail kecil).
3. Buat **1 subtopik** dari halaman ini.
4. Subtopik harus mandiri dan mencakup aspek tertentu (misalnya: definisi, proses, hubungan, contoh, hukum, teorema).
5. Gunakan bahasa yang jelas dan edukatif yang sesuai untuk siswa.
6. Pastikan subtopik memiliki tepat 3–4 kalimat.
...
- **JUMLAH: Buat tepat 1 subtopik dari halaman ini.**
...
Kembalikan analisis dalam format JSON berikut (buat tepat 1 subtopik):
