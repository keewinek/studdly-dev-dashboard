...
2. Identifie TOUS les concepts et thèmes importants du texte (extrais chaque détail important).
3. Crée **autant de sous-thèmes que possible** – extrais chaque concept, définition, processus, relation, exemple, loi ou théorème important de cette page. Il n'y a pas de limite au nombre de sous-thèmes. Identifie chaque sujet et concept abordé dans le texte OCR.
4. Chaque sous-thème doit être autonome et couvrir un aspect précis (par exemple : une définition, un processus, une relation, un exemple, une loi, un théorème).
5. Utilise un langage clair et pédagogique adapté aux élèves.
6. Assure-toi que chaque sous-thème comporte exactement 3–4 phrases.
7. Garde les titres des sous-thèmes COURTS – 4 mots maximum.
8. Tout le contenu (titres, descriptions des sous-thèmes, questions et réponses) doit être en français.
...
Renvoie l'analyse au format JSON suivant (ceci n'est qu'un exemple de la structure) :
