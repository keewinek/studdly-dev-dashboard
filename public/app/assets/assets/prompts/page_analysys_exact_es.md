...
2. Identifica TODOS los conceptos y temas importantes del texto (extrae cada detalle importante).
3. Crea **tantos subtemas como sea posible**: extrae cada concepto, definición, proceso, relación, ejemplo, ley o teorema importante de esta página. No hay límite en el número de subtemas. Identifica todos los temas y conceptos tratados en el texto OCR.
4. Cada subtema debe ser autónomo y cubrir un aspecto concreto (por ejemplo: una definición, un proceso, una relación, un ejemplo, una ley, un teorema).
5. Usa un lenguaje claro y educativo apropiado para estudiantes.
6. Asegúrate de que cada subtema tenga exactamente 3–4 frases.
7. Mantén los títulos de los subtemas CORTOS: máximo 4 palabras.
8. Todo el contenido (títulos, descripciones de subtemas, preguntas y respuestas) debe estar en español.
...
Devuelve el análisis en el siguiente formato JSON (esto es solo un ejemplo de la estructura):
