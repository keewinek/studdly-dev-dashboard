...
2. Identifikasi SEMUA konsep dan topik penting dalam teks (ekstrak setiap detail penting).
3. Buat **sebanyak mungkin subtopik** – ekstrak setiap konsep, definisi, proses, hubungan, contoh, hukum, atau teorema penting dari halaman ini. Tidak ada batas jumlah subtopik. Identifikasi setiap subjek dan konsep yang dibahas dalam teks OCR.
...
Kembalikan analisis dalam format JSON berikut (ini hanya contoh struktur):
