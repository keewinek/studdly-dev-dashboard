...
2. Identifie les concepts et thèmes principaux LES PLUS IMPORTANTS du texte (concentre-toi sur les idées clés, pas sur chaque petit détail).
3. Crée **3 sous-thèmes** à partir de cette page.
...
- **QUANTITÉ : crée exactement 3 sous-thèmes à partir de cette page.**
...
Renvoie l'analyse au format JSON suivant (crée exactement 3 sous-thèmes) :
